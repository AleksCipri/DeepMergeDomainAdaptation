...
def run(point):
    ...
    config["path"] = '/lus/theta-fs0/projects/hpcbdsm/sandeep/New/DeepMergeDomainAdaptation/hyperparameter_search/DeepDA_Mod/DeepDA_Mod/DeepDA_Modhps/small_20percent/' #'DeepMerge/small_20percent/'
