...
def run(point):
    ...
    config["ckpt_path"] = "/lus/theta-fs0/projects/OptADDN/Alex/DeepDA_SDSS_Alex/DeepDA_SDSS_Alex/DeepDA_ADA_TL/"
    ...
    config["loss"] = {"name": transfer_loss_dict[config["transfer_type"]],"ly_type": "cosine", 
                      "fisher_loss_type": "tr",
...
if __name__ == "__main__":
    point = {"lr":1e-5, "trade_off":.01, "cycle_length":2, "weight_decay": 1e-4}
